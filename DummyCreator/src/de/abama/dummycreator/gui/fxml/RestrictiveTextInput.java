...
public class RestrictiveTextInput extends TextField {
    ...
    public RestrictiveTextInput(String promptText, String restriction) {
		this();
		setMinHeight(24);
		setPromptText(promptText);
		setRestrict(restriction);
	}
